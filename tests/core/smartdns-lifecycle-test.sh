...
TEST_SMARTDNS_ENABLED=0 TEST_SMARTDNS_LOG="$log" TEST_IP_LOG="$tmp/ip.log" TEST_NFT_LOG="$tmp/nft.log" PATH="$ROOT/tests/core/stubs:$PATH" \
...
TEST_SMARTDNS_LOG="$log" TEST_IP_LOG="$tmp/ip.log" TEST_NFT_LOG="$tmp/nft.log" PATH="$ROOT/tests/core/stubs:$PATH" \
...
if TEST_SMARTDNS_RELOAD_FAIL=1 TEST_SMARTDNS_LOG="$log" TEST_IP_LOG="$tmp/ip.log" TEST_NFT_LOG="$tmp/nft.log" PATH="$ROOT/tests/core/stubs:$PATH" \
