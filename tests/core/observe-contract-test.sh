...
printf '%s\n' 18446744073709551616 >"$tmp/root/sys/class/net/br-lan/statistics/rx_bytes"
run_observe interfaces >"$tmp/interfaces-u64-overflow.json"
grep -Fq '"device":"br-lan","roles":[{"role":"lan","interface":"lan"}],"online":true,"available":false' "$tmp/interfaces-u64-overflow.json"
grep -Fq '"rx_bytes":null' "$tmp/interfaces-u64-overflow.json"
printf '%s\n' 18446744073709551615 >"$tmp/root/sys/class/net/br-lan/statistics/rx_bytes"
