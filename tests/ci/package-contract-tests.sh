...
grep -q '^PKG_VERSION:=0.3.1$' routepolicy/Makefile || fail '核心包版本未升级到 0.3.1 功能版本'
grep -q '^PKG_VERSION:=0.3.1$' luci-app-routepolicy/Makefile || fail 'LuCI 包版本未同步到 0.3.1 功能版本'
